...
const EpisodeLinks = ({ episode, episode: { channel } }) => {
  ...
  if (episode.link) {
    links.push(
      <a href={episode.link} className="btn btn-info btn-sm">
        <Icon name="info" /> Link
      </a>
    );
  }
  ...
  if (channel.rssFeed) {
    links.push(
      <a href={channel.rssFeed} className="btn btn-info btn-sm">
        <Icon name="rss" /> RSS
      </a>
    );
  }
  ...
  if (channel.link) {
    links.push(
      <a href={channel.link} className="btn btn-info btn-sm">
